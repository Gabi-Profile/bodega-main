...
// Mostrar alertas si hay resultados
        ...
        <div class="filters">
            <form method="GET" action="">
                ...
                <div class="botones-filtros">
                    ...
                    <!-- Botón de Alertas integrado en la línea de filtros -->
...
<!-- aqui cambio -->
 <!-- Botón del Dashboard - Versión corregida -->
        
<!-- aqui cambio -->
        <!-- Botón "Agregar Insumos" (ahora fuera del form de filtros) -->
        <form action="agregarcomp.php" method="post" style="margin-bottom: 15px;">
